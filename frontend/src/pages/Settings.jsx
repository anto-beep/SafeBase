          ...
          <div className="bg-background border-2 border-ink p-6 space-y-4" data-testid="settings-api-panel">
            ...
            {isEnterprise ? (
              ...
              <>
                ...
                <p className="text-sm text-muted-foreground">Connect SafeBase to your ERP, HRIS or BI stack with our full REST API, webhooks and priority integration support. Available on Enterprise — from A$2,199/mo + GST.</p>
                <Button
