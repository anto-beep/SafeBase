...
export default function HaccpCompliancePage() {
  return (
    <SeoLandingPage
      ...
      roiAnchor="Hospitality businesses currently pay A$2,000 to A$4,000 per month on a combined food-safety + WHS consulting retainer. SafeBase Single Venue at A$14,990/year + GST is less than five months of that retainer and adds full WHS."
      painPoints={[
      ...
      plans={[
        { name: "Single Venue", annual: "14,990", monthly: "1,499" },
        { name: "Multi-Venue", annual: "44,990", monthly: "4,499" },
      ]}
      faq={[
