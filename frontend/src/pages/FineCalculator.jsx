      ...
      <section className="py-12 px-6">
        ...
        <div className="max-w-3xl mx-auto text-center mt-12 border-2 border-warning bg-warning/20 p-8">
          ...
          <div className="flex flex-wrap gap-3 justify-center mt-6">
            <Link to="/plan-rightsizer"><Button className="btn-sharp bg-ink text-white hover:bg-authority" data-testid="fine-calc-rightsizer-cta">Find your right-size plan <ArrowRight className="ml-1" /></Button></Link>
            <Link to="/register"><Button variant="outline" className="btn-sharp border-ink" data-testid="fine-calc-cta">Start 14-day free trial</Button></Link>
          </div>
        </div>
      </section>
    </MarketingLayout>
