    ...
    <div className="bg-background">
      ...
      <section className="border-b border-border bg-muted">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-border border border-border">
            {[
              { code: "01", t: "SafeBase Core", d: "Compliance documents, incident management, credential tracking, risk register — configured for your industry.", p: "from A$799/mo + GST" },
              { code: "02", t: "SafeInduct", d: "QR-based inductions for sites, venues, depots, clinics and stores. AI-generated location-specific inductions.", p: "A$299/mo + GST · included Tier 2+" },
              { code: "03", t: "SafeCheck", d: "Portable compliance credential — verified licences, AHPRA, RSA certificates and insurances in one QR code.", p: "A$349/mo + GST · included Tier 3+" },
              { code: "04", t: "SafeBase Academy", d: "Industry-specific microlearning and full certification courses. Completion syncs to your compliance dashboard.", p: "from A$499/mo + GST · included Tier 3+" },
