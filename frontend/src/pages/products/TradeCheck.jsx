      ...
      <section className="border-b border-border">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16 lg:py-24 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-7">
            <div className="label-eyebrow mb-3">/ TradeCheck</div>
            <h1 className="font-display text-5xl lg:text-7xl font-black tracking-tighter leading-[0.95]">Your entire<br />compliance record.<br /><span className="bg-warning px-2">One QR code.</span></h1>
            <p className="mt-8 text-lg text-muted-foreground max-w-2xl">Portable compliance credential for subcontractors. Verified licences, insurance and white cards — in one shareable badge. Builders scan to verify, AI flags issues.</p>
          ...
          <div className="lg:col-span-5 bg-ink text-white p-8 border-2 border-ink">
            <div className="flex items-center justify-between">
              <div className="label-eyebrow text-warning">/ TRADECHECK PROFILE</div>
              <div className="flex items-center gap-1 bg-emerald-500 text-white px-2 py-1 text-xs font-bold">✓ VERIFIED</div>
            </div>
            <div className="font-display font-black text-3xl mt-4">Dave Morrison</div>
            <div className="text-white/70">Morrison Roofing Pty Ltd · ABN 84 000 000 000</div>
            <div className="mt-6 space-y-2 text-sm font-mono">
              ...
              <div className="flex justify-between border-b border-white/10 py-2"><span>Builders Licence</span><span className="text-warning">L-9248-NSW</span></div>
            ...
            <div className="mt-4 flex items-center gap-3">
              ...
              <div className="text-xs text-white/60">tradecheck.safetradie.com.au/dmorrison</div>
            </div>
          </div>
        </div>
      </section>
